...
# ddeaguiar build configuration file, created by
# `ablog start` on Sat Mar 25 18:38:55 2017.
#
...
blog_title = u'Software in Context'
...
blog_authors = {
    'Daniel De Aguiar': ('Daniel De Aguiar', None),
}
...
project = u'Software in Context'
copyright = u'2017, Daniel De Aguiar'
author = u'Daniel De Aguiar'
...
htmlhelp_basename = 'ddeaguiardoc'

github_pages = 'ddeaguiar'
